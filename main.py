...
class AngpaoModal(discord.ui.Modal, title="( กรุณากรอกลิงก์ซองอั่งเปา )"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            "✅ ส่งซองอั่งเปาเรียบร้อยแล้ว! __*โปรดรอแอดมินตรวจสอบสักครู่*__",
            ephemeral=True
        )
...
class MainView(discord.ui.View):
    ...
    async def rank_info(self, interaction: discord.Interaction, _):
        ...
        embed = discord.Embed(
            ...
            description=(
                "<@&1082885961953853540>\n"
                "• ราคายศรวมทั้งหมด : __**129฿**__ *(คุ้มกว่า!)* <a:1fire:1475406259564839103> <a:1fire:1475406259564839103> <a:1fire:1475406259564839103>\n\n"
                "<@&1082668970718527508>\n"
                "• ตัวอย่างห้อง: <#1476799529767665685>\n"
                "• ราคายศ : __**79฿**__\n\n"
                "<@&1082667309254054008>\n"
                "• ตัวอย่างห้อง: <#1476797753169543300>\n"
                "• ราคายศ : __**30฿**__\n\n"
                "<@&1082667313163157515>\n"
                "• ตัวอย่างห้อง: <#1476793261489389839>\n"
                "• ราคายศ : __**50฿**__"
            ),
            color=0xFFD700
        )

        embed.set_image(url="https://i.postimg.cc/QMVTYv8Z/pink.gif")
